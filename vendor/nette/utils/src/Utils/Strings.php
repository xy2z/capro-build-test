...
namespace _PhpScoper5e9ecd738c28\Nette\Utils;

use _PhpScoper5e9ecd738c28\JetBrains\PhpStorm\Language;
use _PhpScoper5e9ecd738c28\Nette;
...
class Strings
{
     ...
     */
    public static function split(string $subject, #[\JetBrains\PhpStorm\Language('RegExp')] string $pattern, bool|int $captureOffset = \false, bool $skipEmpty = \false, int $limit = -1, bool $utf8 = \false) : array
    {
     ...
     */
    public static function match(string $subject, #[\JetBrains\PhpStorm\Language('RegExp')] string $pattern, bool|int $captureOffset = \false, int $offset = 0, bool $unmatchedAsNull = \false, bool $utf8 = \false) : ?array
    {
     ...
     */
    public static function matchAll(string $subject, #[\JetBrains\PhpStorm\Language('RegExp')] string $pattern, bool|int $captureOffset = \false, int $offset = 0, bool $unmatchedAsNull = \false, bool $patternOrder = \false, bool $utf8 = \false) : array
    {
     ...
     */
    public static function replace(string $subject, #[\JetBrains\PhpStorm\Language('RegExp')] string|array $pattern, string|callable $replacement = '', int $limit = -1, bool $captureOffset = \false, bool $unmatchedAsNull = \false, bool $utf8 = \false) : string
    {
