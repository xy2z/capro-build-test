 ...
 */
namespace _PhpScoper5e9ecd738c28\Composer;

use _PhpScoper5e9ecd738c28\Composer\Autoload\ClassLoader;
use _PhpScoper5e9ecd738c28\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper5e9ecd738c28\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
