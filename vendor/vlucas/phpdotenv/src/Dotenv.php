...
namespace _PhpScoper5e9ecd738c28\Dotenv;

use _PhpScoper5e9ecd738c28\Dotenv\Exception\InvalidPathException;
use _PhpScoper5e9ecd738c28\Dotenv\Loader\Loader;
use _PhpScoper5e9ecd738c28\Dotenv\Loader\LoaderInterface;
use _PhpScoper5e9ecd738c28\Dotenv\Parser\Parser;
use _PhpScoper5e9ecd738c28\Dotenv\Parser\ParserInterface;
use _PhpScoper5e9ecd738c28\Dotenv\Repository\Adapter\ArrayAdapter;
use _PhpScoper5e9ecd738c28\Dotenv\Repository\Adapter\PutenvAdapter;
use _PhpScoper5e9ecd738c28\Dotenv\Repository\RepositoryBuilder;
use _PhpScoper5e9ecd738c28\Dotenv\Repository\RepositoryInterface;
use _PhpScoper5e9ecd738c28\Dotenv\Store\StoreBuilder;
use _PhpScoper5e9ecd738c28\Dotenv\Store\StoreInterface;
use _PhpScoper5e9ecd738c28\Dotenv\Store\StringStore;
class Dotenv
{
    /**
     * The store instance.
