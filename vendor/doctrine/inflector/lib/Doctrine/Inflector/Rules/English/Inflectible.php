...
namespace _PhpScoper5e9ecd738c28\Doctrine\Inflector\Rules\English;
...
class Inflectible
{
    ...
    {
        (yield new Transformation(new Pattern('(s)tatuses$'), '_PhpScoper5e9ecd738c28\\1\\2tatus'));
        (yield new Transformation(new Pattern('(s)tatus$'), '_PhpScoper5e9ecd738c28\\1\\2tatus'));
        (yield new Transformation(new Pattern('(c)ampus$'), '_PhpScoper5e9ecd738c28\\1\\2ampus'));
        (yield new Transformation(new Pattern('^(.*)(menu)s$'), '_PhpScoper5e9ecd738c28\\1\\2'));
        ...
        (yield new Transformation(new Pattern('(m)ovies$'), '_PhpScoper5e9ecd738c28\\1\\2ovie'));
        (yield new Transformation(new Pattern('(s)eries$'), '_PhpScoper5e9ecd738c28\\1\\2eries'));
        ...
        (yield new Transformation(new Pattern('(analy|diagno|^ba|(p)arenthe|(p)rogno|(s)ynop|(t)he)ses$'), '_PhpScoper5e9ecd738c28\\1\\2sis'));
        ...
        (yield new Transformation(new Pattern('(p)eople$'), '_PhpScoper5e9ecd738c28\\1\\2erson'));
        (yield new Transformation(new Pattern('(m)en$'), '\\1an'));
        (yield new Transformation(new Pattern('(c)hildren$'), '_PhpScoper5e9ecd738c28\\1\\2hild'));
        (yield new Transformation(new Pattern('(f)eet$'), '\\1oot'));
        (yield new Transformation(new Pattern('(n)ews$'), '_PhpScoper5e9ecd738c28\\1\\2ews'));
    ...
    {
        (yield new Transformation(new Pattern('(s)tatus$'), '_PhpScoper5e9ecd738c28\\1\\2tatuses'));
        (yield new Transformation(new Pattern('(quiz)$'), '\\1zes'));
        (yield new Transformation(new Pattern('^(ox)$'), '_PhpScoper5e9ecd738c28\\1\\2en'));
        ...
        (yield new Transformation(new Pattern('(?:([^f])fe|([lr])f)$'), '_PhpScoper5e9ecd738c28\\1\\2ves'));
        ...
        (yield new Transformation(new Pattern('(buffal|her|potat|tomat|volcan)o$'), '_PhpScoper5e9ecd738c28\\1\\2oes'));
