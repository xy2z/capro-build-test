...
namespace _PhpScoper5e9ecd738c28\Jenssegers\Blade;

use _PhpScoper5e9ecd738c28\Illuminate\Container\Container;
use _PhpScoper5e9ecd738c28\Illuminate\Contracts\Container\Container as ContainerInterface;
use _PhpScoper5e9ecd738c28\Illuminate\Contracts\Foundation\Application;
use _PhpScoper5e9ecd738c28\Illuminate\Contracts\View\Factory as FactoryContract;
use _PhpScoper5e9ecd738c28\Illuminate\Contracts\View\View;
use _PhpScoper5e9ecd738c28\Illuminate\Events\Dispatcher;
use _PhpScoper5e9ecd738c28\Illuminate\Filesystem\Filesystem;
use _PhpScoper5e9ecd738c28\Illuminate\Support\Facades\Facade;
use _PhpScoper5e9ecd738c28\Illuminate\View\Compilers\BladeCompiler;
use _PhpScoper5e9ecd738c28\Illuminate\View\Factory;
use _PhpScoper5e9ecd738c28\Illuminate\View\ViewServiceProvider;
