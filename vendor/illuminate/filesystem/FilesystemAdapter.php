...
namespace _PhpScoper5e9ecd738c28\Illuminate\Filesystem;

use Closure;
use _PhpScoper5e9ecd738c28\Illuminate\Contracts\Filesystem\Cloud as CloudFilesystemContract;
use _PhpScoper5e9ecd738c28\Illuminate\Contracts\Filesystem\FileExistsException as ContractFileExistsException;
use _PhpScoper5e9ecd738c28\Illuminate\Contracts\Filesystem\FileNotFoundException as ContractFileNotFoundException;
use _PhpScoper5e9ecd738c28\Illuminate\Contracts\Filesystem\Filesystem as FilesystemContract;
use _PhpScoper5e9ecd738c28\Illuminate\Http\File;
use _PhpScoper5e9ecd738c28\Illuminate\Http\UploadedFile;
use _PhpScoper5e9ecd738c28\Illuminate\Support\Arr;
use _PhpScoper5e9ecd738c28\Illuminate\Support\Collection;
use _PhpScoper5e9ecd738c28\Illuminate\Support\Str;
use _PhpScoper5e9ecd738c28\Illuminate\Support\Traits\Macroable;
use InvalidArgumentException;
use _PhpScoper5e9ecd738c28\League\Flysystem\Adapter\Ftp;
use _PhpScoper5e9ecd738c28\League\Flysystem\Adapter\Local as LocalAdapter;
use _PhpScoper5e9ecd738c28\League\Flysystem\AdapterInterface;
use _PhpScoper5e9ecd738c28\League\Flysystem\AwsS3v3\AwsS3Adapter;
use _PhpScoper5e9ecd738c28\League\Flysystem\Cached\CachedAdapter;
use _PhpScoper5e9ecd738c28\League\Flysystem\FileExistsException;
use _PhpScoper5e9ecd738c28\League\Flysystem\FileNotFoundException;
use _PhpScoper5e9ecd738c28\League\Flysystem\FilesystemInterface;
use _PhpScoper5e9ecd738c28\League\Flysystem\Sftp\SftpAdapter as Sftp;
use _PhpScoper5e9ecd738c28\PHPUnit\Framework\Assert as PHPUnit;
use _PhpScoper5e9ecd738c28\Psr\Http\Message\StreamInterface;
use _PhpScoper5e9ecd738c28\Psr\Http\Message\UriInterface;
use RuntimeException;
use _PhpScoper5e9ecd738c28\Symfony\Component\HttpFoundation\StreamedResponse;
/**
