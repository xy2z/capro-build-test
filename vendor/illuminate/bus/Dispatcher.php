...
use Closure;
use _PhpScoper5e9ecd738c28\Illuminate\Contracts\Bus\QueueingDispatcher;
use _PhpScoper5e9ecd738c28\Illuminate\Contracts\Container\Container;
use _PhpScoper5e9ecd738c28\Illuminate\Contracts\Queue\Queue;
use _PhpScoper5e9ecd738c28\Illuminate\Contracts\Queue\ShouldQueue;
use _PhpScoper5e9ecd738c28\Illuminate\Foundation\Bus\PendingChain;
use _PhpScoper5e9ecd738c28\Illuminate\Pipeline\Pipeline;
use _PhpScoper5e9ecd738c28\Illuminate\Queue\InteractsWithQueue;
use _PhpScoper5e9ecd738c28\Illuminate\Queue\Jobs\SyncJob;
