...
use Closure;
use _PhpScoper5e9ecd738c28\Illuminate\Contracts\Queue\Factory as QueueFactory;
use _PhpScoper5e9ecd738c28\Illuminate\Contracts\Support\Arrayable;
use _PhpScoper5e9ecd738c28\Illuminate\Queue\CallQueuedClosure;
...
class Batch implements Arrayable, JsonSerializable
{
    ...
    protected function invokeHandlerCallback($handler, Batch $batch, Throwable $e = null)
    {
        try {
            ...
            if (\function_exists('_PhpScoper5e9ecd738c28\\report')) {
                report($e);
            }
        }
    }
