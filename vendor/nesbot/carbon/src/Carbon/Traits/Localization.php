 ...
 */
namespace _PhpScoper5e9ecd738c28\Carbon\Traits;

use _PhpScoper5e9ecd738c28\Carbon\CarbonInterface;
use _PhpScoper5e9ecd738c28\Carbon\Exceptions\InvalidTypeException;
use _PhpScoper5e9ecd738c28\Carbon\Exceptions\NotLocaleAwareException;
use _PhpScoper5e9ecd738c28\Carbon\Language;
use _PhpScoper5e9ecd738c28\Carbon\Translator;
use _PhpScoper5e9ecd738c28\Carbon\TranslatorStrongTypeInterface;
use Closure;
use _PhpScoper5e9ecd738c28\Symfony\Component\Translation\TranslatorBagInterface;
use _PhpScoper5e9ecd738c28\Symfony\Component\Translation\TranslatorInterface;
use _PhpScoper5e9ecd738c28\Symfony\Contracts\Translation\LocaleAwareInterface;
use _PhpScoper5e9ecd738c28\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
// @codeCoverageIgnoreStart
if (\interface_exists('_PhpScoper5e9ecd738c28\\Symfony\\Contracts\\Translation\\TranslatorInterface') && !\interface_exists('_PhpScoper5e9ecd738c28\\Symfony\\Component\\Translation\\TranslatorInterface')) {
    \class_alias('_PhpScoper5e9ecd738c28\\Symfony\\Contracts\\Translation\\TranslatorInterface', '_PhpScoper5e9ecd738c28\\Symfony\\Component\\Translation\\TranslatorInterface');
}
