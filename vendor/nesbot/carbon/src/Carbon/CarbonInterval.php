...
use _PhpScoper5e9ecd738c28\Carbon\Exceptions\BadFluentConstructorException;
use _PhpScoper5e9ecd738c28\Carbon\Exceptions\BadFluentSetterException;
use _PhpScoper5e9ecd738c28\Carbon\Exceptions\InvalidCastException;
use _PhpScoper5e9ecd738c28\Carbon\Exceptions\InvalidIntervalException;
use _PhpScoper5e9ecd738c28\Carbon\Exceptions\OutOfRangeException;
use _PhpScoper5e9ecd738c28\Carbon\Exceptions\ParseErrorException;
use _PhpScoper5e9ecd738c28\Carbon\Exceptions\UnitNotConfiguredException;
use _PhpScoper5e9ecd738c28\Carbon\Exceptions\UnknownGetterException;
use _PhpScoper5e9ecd738c28\Carbon\Exceptions\UnknownSetterException;
use _PhpScoper5e9ecd738c28\Carbon\Exceptions\UnknownUnitException;
use _PhpScoper5e9ecd738c28\Carbon\Traits\IntervalRounding;
use _PhpScoper5e9ecd738c28\Carbon\Traits\IntervalStep;
use _PhpScoper5e9ecd738c28\Carbon\Traits\MagicParameter;
use _PhpScoper5e9ecd738c28\Carbon\Traits\Mixin;
use _PhpScoper5e9ecd738c28\Carbon\Traits\Options;
use _PhpScoper5e9ecd738c28\Carbon\Traits\ToStringFormat;
use Closure;
use DateInterval;
use _PhpScoper5e9ecd738c28\DateMalformedIntervalStringException;
