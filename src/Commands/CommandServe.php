 ...
 */
class CommandServe implements \xy2z\Capro\Commands\CommandInterface
{
    /** @var array<mixed> */
    ...
    {
        $this->server = Server::new()->host($this->host)->port($this->port)->root(\CAPRO_PUBLIC_DIR);
    ...
    {
        // Restart build timer.
        static::$time_start_build = \microtime(\true);
